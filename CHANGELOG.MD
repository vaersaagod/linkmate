...
## Unreleased
### Fixed
- Fixes an issue due to my dumb brain, where the site menu would always display regardless of the "Show site menu" option actually being checked or not FFS  
