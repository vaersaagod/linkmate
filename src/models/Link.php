 ...
 *
 * @property-read bool                   $enableTitle
 * @property-read null|string            $url
 * @property-read Site                   $ownerSite
 * @property-read bool                   $allowTarget
 * @property-read bool                   $enableAriaLabel
 * @property-read null|LinkTypeInterface $linkType
 * @property-read string                 $defaultText
 * @property-read null|string            $text
 * @property-read bool                   $allowCustomText
 */
class Link extends Model
{
    ...
    public function __construct($config = [])
    {
        ...
        unset($config['linkField'], $config['owner']);
    ...
    {
        if (!isset($this->prefetchedElement) || $this->prefetchedElement->getId() != $this->value) {
            $linkType = $this->getLinkType();
            $element = is_null($linkType) ? null : $linkType->getElement($this, $ignoreStatus);
    ...
    public function getLinkType(): ?LinkTypeInterface
    {
        ...
        return $linkTypes[$this->type] ?? null;
    }
    ...
    {
        if (!empty($this->customText) && $this->getAllowCustomText()) {
     ...
     * @internal
     */
    public function setPrefetchedElement($element): void
    {
        $this->prefetchedElement = $element;
    }
